...
// wrapc file define:
#define AUTOTB_TVIN_x "../tv/cdatafile/c.top_A.autotvin_x.dat"
#define AUTOTB_TVOUT_x "../tv/cdatafile/c.top_A.autotvout_x.dat"
#define AUTOTB_TVIN_p1 "../tv/cdatafile/c.top_A.autotvin_p1.dat"
#define AUTOTB_TVOUT_p1 "../tv/cdatafile/c.top_A.autotvout_p1.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_p1 "../tv/rtldatafile/rtl.top_A.autotvout_p1.dat"
...
extern "C"
void top_A_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_top_A_hw(void* __xlx_apatb_param_x, void* __xlx_apatb_param_p1)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_p1),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_p1),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_p1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_p1),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_p1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_p1),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_p1 };
  port1.nbytes = { 588 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    top_A_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_p1);
