# 1 "Lenet_RTL_test/lenet_conv1_only.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lenet_RTL_test/lenet_conv1_only.cpp" 2
# 18 "Lenet_RTL_test/lenet_conv1_only.cpp"
...
# 19 "Lenet_RTL_test/lenet_conv1_only.cpp" 2
...
# 20 "Lenet_RTL_test/lenet_conv1_only.cpp" 2
...
# 54 "Lenet_RTL_test/lenet_conv1_only.cpp"
...
# 83 "Lenet_RTL_test/lenet_conv1_only.cpp"
...
# 112 "Lenet_RTL_test/lenet_conv1_only.cpp"
...
#pragma HLS ALLOCATION operation instances=mul limit=2
 ...
 VITIS_LOOP_117_1: for (int oc = 0; oc < C1_OUT; oc++) {
        VITIS_LOOP_118_2: for (int oh = 0; oh < C1_H; oh++) {
            VITIS_LOOP_119_3: for (int ow = 0; ow < C1_WO; ow++) {
#pragma HLS PIPELINE II=2
 int32_t acc = LENET_C1_B[oc];
#pragma HLS UNROLL factor=2
 VITIS_LOOP_123_4: for (int kh = 0; kh < C1_K; kh++) {
#pragma HLS UNROLL factor=2
 VITIS_LOOP_125_5: for (int kw = 0; kw < C1_K; kw++) {
                        int16_t a = (int16_t)x[oh + kh][ow + kw];
                        int16_t b = (int16_t)LENET_C1_W[oc][0][kh][kw];
                        acc += (int32_t)a * (int32_t)b;
                    }
                }
                y[oc][oh][ow] = requant_u8_q15(acc, ((int32_t)(((3.92156886e-03f) * (0.004256003070622683f) / (2.22108141e-02f)) * (1 << 15))), (0));
            }
        }
    }
}
...
{
    VITIS_LOOP_140_1: for (int c = 0; c < C1_OUT; c++) {
        VITIS_LOOP_141_2: for (int oh = 0; oh < P1_H; oh++) {
            VITIS_LOOP_142_3: for (int ow = 0; ow < P1_W; ow++) {
#pragma HLS PIPELINE II=2
 int ih = oh << 1;
                int iw = ow << 1;
...
__attribute__((sdx_kernel("top_A", 0))) void top_A(const uint8_t x[IN_H][IN_W], uint8_t p1[C1_OUT][P1_H][P1_W])
{
#line 19 "C:/Users/myodo/Desktop/Lenet/Lenet_RTL_test/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=top_A
# 157 "Lenet_RTL_test/lenet_conv1_only.cpp"
