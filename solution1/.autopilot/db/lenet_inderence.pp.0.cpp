# 1 "Lenet_RTL_test/lenet_inderence.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lenet_RTL_test/lenet_inderence.cpp" 2
...
# 2 "Lenet_RTL_test/lenet_inderence.cpp" 2
...
# 3 "Lenet_RTL_test/lenet_inderence.cpp" 2
...
# 1 "Lenet_RTL_test/lenet_params_int8.h" 1
...
# 11 "Lenet_RTL_test/lenet_inderence.cpp" 2
# 1 "Lenet_RTL_test/lenet_qparams_min.h" 1
# 12 "Lenet_RTL_test/lenet_inderence.cpp" 2
...
# 51 "Lenet_RTL_test/lenet_inderence.cpp"
...
# 73 "Lenet_RTL_test/lenet_inderence.cpp"
...
#pragma HLS ALLOCATION operation instances=mul limit=2
 ...
 VITIS_LOOP_77_1: for (int oc = 0; oc < C1_OUT; oc++) {
        VITIS_LOOP_78_2: for (int oh = 0; oh < C1_H; oh++) {
            VITIS_LOOP_79_3: for (int ow = 0; ow < C1_WO; ow++) {
#pragma HLS PIPELINE II=4
 ...
 int32_t acc = LENET_C1_B[oc];
                ...
                VITIS_LOOP_87_4: for (int kh = 0; kh < C1_K; kh++) {
#pragma HLS UNROLL factor=1
 VITIS_LOOP_89_5: for (int kw = 0; kw < C1_K; kw++) {
#pragma HLS UNROLL factor=1
 int16_t a = x[oh + kh][ow + kw];
                        int16_t b = LENET_C1_W[oc][0][kh][kw];
                ...
                uint8_t val = requant_u8_q15(acc, ((int32_t)(((3.92156886e-03f) * LENET_C1_W_SCALE / (2.22108141e-02f)) * (1 << 15))), (0));
# 116 "Lenet_RTL_test/lenet_inderence.cpp"
                y[oc][oh][ow] = val;
            }
        }
    }
...
static void maxpool2x2_s2_c1(const uint8_t x[C1_OUT][C1_H][C1_WO],
    ...
    VITIS_LOOP_127_1: for (int c = 0; c < C1_OUT; c++) {
        VITIS_LOOP_128_2: for (int oh = 0; oh < P1_H; oh++) {
            VITIS_LOOP_129_3: for (int ow = 0; ow < P1_W; ow++) {
...
#pragma HLS ALLOCATION operation instances=mul limit=2
 ...
 VITIS_LOOP_152_1: for (int oc = 0; oc < C2_OUT; oc++) {
        VITIS_LOOP_153_2: for (int oh = 0; oh < C2_H; oh++) {
            VITIS_LOOP_154_3: for (int ow = 0; ow < C2_WO; ow++) {
#pragma HLS PIPELINE II=4


 int32_t acc = LENET_C2_B[oc];


                VITIS_LOOP_161_4: for (int ic = 0; ic < C2_IN; ic++) {
#pragma HLS UNROLL factor=1
 VITIS_LOOP_163_5: for (int kh = 0; kh < C2_K; kh++) {
#pragma HLS UNROLL factor=1
 VITIS_LOOP_165_6: for (int kw = 0; kw < C2_K; kw++) {
#pragma HLS UNROLL factor=1
 int16_t a = x[ic][oh + kh][ow + kw];
                ...
                uint8_t val = requant_u8_q15(acc, ((int32_t)(((2.22108141e-02f) * LENET_C2_W_SCALE / (5.31273969e-02f)) * (1 << 15))), (0));
...
static void maxpool2x2_s2_c2(const uint8_t x[C2_OUT][C2_H][C2_WO],
    ...
    VITIS_LOOP_189_1: for (int c = 0; c < C2_OUT; c++) {
        VITIS_LOOP_190_2: for (int oh = 0; oh < P2_H; oh++) {
            VITIS_LOOP_191_3: for (int ow = 0; ow < P2_W; ow++) {
#pragma HLS PIPELINE II=2
 int ih = oh << 1;
                int iw = ow << 1;
                uint8_t m1 = (x[c][ih][iw] > x[c][ih][iw+1])
...
static void flatten_c2(const uint8_t x[C2_OUT][P2_H][P2_W],
                       uint8_t out[FC_IN]) {
    int idx = 0;
    VITIS_LOOP_211_1: for (int c = 0; c < C2_OUT; c++)
        VITIS_LOOP_212_2: for (int h = 0; h < P2_H; h++)
            VITIS_LOOP_213_3: for (int w = 0; w < P2_W; w++) {
#pragma HLS PIPELINE II=2
 out[idx++] = x[c][h][w];
            }
}
...
#pragma HLS ALLOCATION operation instances=mul limit=2
 ...
 VITIS_LOOP_225_1: for (int o = 0; o < FC_OUT; o++) {
#pragma HLS PIPELINE II=4


 int32_t acc = LENET_FC_B[o];


        VITIS_LOOP_232_2: for (int i = 0; i < FC_IN; i++) {
#pragma HLS UNROLL factor=1
 int16_t a = x[i];
            int16_t b = LENET_FC_W[o][i];
            acc += (int32_t)a * (int32_t)b;
        }



        out_q[o] = requant_u8_q15(acc, ((int32_t)(((5.31273969e-02f) * LENET_FC_W_SCALE / (2.15736702e-01f)) * (1 << 15))), (150));
    }
}
...
#pragma HLS BIND_STORAGE variable=scores_q type=RAM_2P impl=BRAM
 ...
 VITIS_LOOP_277_1: for (int r = 0; r < IN_H; r++)
        VITIS_LOOP_278_2: for (int c = 0; c < IN_W; c++) {
#pragma HLS PIPELINE II=1
 x0[r][c] = in_img_u8[r * IN_W + c];
    ...
    VITIS_LOOP_292_3: for (int i = 0; i < FC_OUT; i++) {
#pragma HLS PIPELINE II=1
 out_scores_i32[i] = (int32_t)scores_q[i];
    }
}
}
