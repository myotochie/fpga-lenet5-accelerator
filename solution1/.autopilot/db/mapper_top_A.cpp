...
using hls::sim::Byte;
extern "C" void top_A(Byte<1>*, Byte<1>*);
extern "C" void apatb_top_A_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_p1) {
using hls::sim::createStream;
  // Collect __xlx_x__tmp_vec
std::vector<Byte<1>> __xlx_x__tmp_vec;
for (size_t i = 0; i < 1024; ++i){
__xlx_x__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_x)[i]);
}
  int __xlx_size_param_x = 1024;
  int __xlx_offset_param_x = 0;
  int __xlx_offset_byte_param_x = 0*1;
  // Collect __xlx_p1__tmp_vec
std::vector<Byte<1>> __xlx_p1__tmp_vec;
for (size_t i = 0; i < 588; ++i){
__xlx_p1__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_p1)[i]);
}
  int __xlx_size_param_p1 = 588;
  int __xlx_offset_param_p1 = 0;
  int __xlx_offset_byte_param_p1 = 0*1;
  // DUT call
  top_A(__xlx_x__tmp_vec.data(), __xlx_p1__tmp_vec.data());
// print __xlx_apatb_param_x
for (size_t i = 0; i < __xlx_size_param_x; ++i) {
((Byte<1>*)__xlx_apatb_param_x)[i] = __xlx_x__tmp_vec[__xlx_offset_param_x+i];
}
// print __xlx_apatb_param_p1
for (size_t i = 0; i < __xlx_size_param_p1; ++i) {
((Byte<1>*)__xlx_apatb_param_p1)[i] = __xlx_p1__tmp_vec[__xlx_offset_param_p1+i];
}
}
